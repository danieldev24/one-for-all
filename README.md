...
> ```bash
> /plugin marketplace add https://github.com/danieldev24/one-for-all.git
> /plugin install one-for-all@one-for-all
> ```
...
See [docs/getting-started.md](docs/getting-started.md) for usage details.
...
|-------|-------------|----------|
| [using-one-for-all](skills/using-one-for-all/SKILL.md) | Maps incoming work to the right skill workflow and defines shared operating rules | Starting a session or deciding which skill applies |
...
AI coding agents default to the shortest path - which often means skipping specs, tests, security reviews, and the practices that make software reliable. one-for-all gives agents structured workflows that enforce the same discipline senior engineers bring to production code.
