...
to prefer existing components, native browser behavior, and design tokens before
creating new UI frameworks or one-off styling systems. Accessibility is part of
the minimum, not polish.
